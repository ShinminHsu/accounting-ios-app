...
- [x] 14.2 **[手動 — 需切換至另一台電腦]** 此電腦太舊無法執行 `npx expo run:ios`，需先將程式碼推上 GitHub，再於另一台 Mac 上進行以下步驟
- [x] 14.2a **[手動]** 將程式碼推上 GitHub，於另一台 Mac clone/pull 最新版本
- [x] 14.2b **[手動]** 在另一台 Mac 執行 `npx expo run:ios --device --configuration Release`，安裝至實體裝置並拔線測試
- [x] 14.2c–g **[已移至 parked change: testflight-distribution]**
